...
public class ConstructorPage {
    ...
    public SelenideElement getToppingButton() {
        return element(TOPPING_BUTTON);
    }
    public SelenideElement getChooseBun() {
        return element(CHOOSE_TOPPING_BUN);
    }
    public SelenideElement getMakeOrder() {
        return element(MAKE_ORDER);
    }
    public SelenideElement getOrderFeed() {
        return element(SWITCHIN_ORDER_FEED);
    }
}